...
export const zh = {
  ...
  jutsu: {
    rasengan: {
      name: "螺旋丸",
      kanji: "螺旋丸",
      description: "自创忍术 — 一颗自我维持的、高度浓缩的旋转查克拉球。",
      gesture: "张开手掌",
      instructions: [
        "将右手伸向摄像头",
        "五指完全张开",
    ...
    fireball: {
      name: "火遁·火球术",
      kanji: "火遁",
      description: "火遁·豪火球之术 — 一颗吞噬一切的巨大火球。",
      gesture: "竖大拇指",
      instructions: [
        "用任意一只手握拳",
        "拇指竖直向上",
    ...
    sharingan: {
      name: "写轮眼",
      kanji: "写輪眼",
      description: "写轮眼 — 赋予看穿查克拉、预判动作、复制忍术的能力。",
      gesture: "剪刀手 / V字",
      instructions: [
        "伸出食指和中指（V字手势）",
        "无名指、小指和拇指弯曲",
    ...
    "eight-gates": {
      name: "八门遁甲",
      kanji: "八門遁甲",
      description: "八门遁甲 — 打开体内八门查克拉穴，以巨大代价获得强大力量。",
      gesture: "握拳",
      instructions: [
        "用任意一只手用力握拳",
        "五指向内弯曲",
    ...
    "chibaku-tensei": {
      name: "地爆天星",
      kanji: "地爆天星",
      description: "地爆天星 — 创造一个引力核心，将一切物质吸入巨大球体。",
      gesture: "手掌朝下",
      instructions: [
        "五指伸直",
        "手掌朝下（指尖低于手腕）",
